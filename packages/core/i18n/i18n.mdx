...
import I18n, { I18nProvider, useT, withT } from '@meta-react/i18n'
import JsonViewer from '@idea/web-app/components/JsonViewer'

# @idea/i18n
```js
import { dictionaries } from '@idea/i18n'
import I18n, { useT, withT, I18nProvider, dictionaries } from '@meta-react/i18n'
```
