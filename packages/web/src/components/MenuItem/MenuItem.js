...
const MenuItem = (props) => {
  ...
  const menuItem = useMemo(
      ...
      const item = (
        <>
          ...
          {drawerIsOpen && (
            <ListItemText
              primary={ label }
              primaryTypographyProps={ { style: { lineHeight: 1, whiteSpace: 'normal' } } }
    ...
    [Icon, classes.activeIndicator, classes.arrow, classes.icon, classes.listItemIcon, classes.menuActive, classes.menuLink, classes.text, drawerIsOpen, exact, hasSubMenu, label, openSubMenu, url, withArrow, withIndicator]
  )
